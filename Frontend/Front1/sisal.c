...
staticforward int hash PROTO(( Char,Char ));
...
staticforward void outtype PROTO(( FILE*,stentry*,boolean ));
...
staticforward void pusharray PROTO(( boolean ));
staticforward void pushstream PROTO(( boolean ));
staticforward void pushrecord PROTO(( boolean ));
staticforward void pushunion PROTO(( boolean ));
...
staticforward void buildfort PROTO(( char,boolean ));
staticforward void buildfield PROTO(( boolean ));
staticforward void buildtag PROTO(( boolean ));
...
staticforward inforecord* errtype_ PROTO(( char,stentry*,struct LOC_dopredefined* ));
staticforward inforecord* maxmin PROTO(( unchar,semanticrec*,int,stryng,struct LOC_dopredefined* ));
staticforward inforecord* addhlarrayorstream PROTO(( char,semanticrec*,unchar,int,stryng,struct LOC_dopredefined* ));
staticforward inforecord* sizearrayorstream PROTO(( predeftype,char,semanticrec*,int,stryng,struct LOC_dopredefined* ));
staticforward inforecord* remhlarrayorstream PROTO(( char,semanticrec*,unchar,int,stryng,struct LOC_dopredefined* ));
...
staticforward void buildfunctgraph PROTO(( symtblbucket*,stryng,int,boolean ));
...
staticforward void endiftagsubgraph PROTO(( boolean ));
...
staticforward void seeke PROTO(( char,stryng ));
staticforward void getprefixinfo PROTO(( char,stryng ));
...
staticforward void llinsert PROTO(( char,stagerec*,stryng* ));
...
staticforward SHORT findlltab PROTO(( SHORT,char ));
...
staticforward void ctrlchtooctal PROTO(( Char,stryng*,struct LOC_scan* ));
...
staticforward boolean checkepsilonok PROTO(( char ));
...
staticforward int removegraphcse PROTO(( node*,boolean ));
...
staticforward void insertchar PROTO((stryng*,Char,int));
...
staticforward void askordefault PROTO((parrec*,stryng*,boolean,Char*));
...
staticforward void concatchar PROTO((stryng*,Char));
...
staticforward Char uppercase PROTO(( Char ));
staticforward Char lowercase PROTO(( Char ));
staticforward boolean matchstrings PROTO(( stryng*,stryng*,int ));
staticforward int findchar PROTO(( Char,stryng*,int ));
staticforward int findlastchar PROTO(( Char,stryng* ));
staticforward void numberstring PROTO(( stryng*,int,int ));
staticforward int charval PROTO(( Char ));
staticforward void initnames PROTO(( void ));
...
staticforward stentry* newtypealloc PROTO(( char ));
staticforward port* newedgealloc PROTO(( portsort ));
staticforward node* newnodealloc PROTO(( nodesort ));
staticforward void initstamps PROTO(( void ));
staticforward void removestamp PROTO(( Char ));
staticforward void addstamp PROTO(( Char,stryng ));
staticforward int numbofsubgraphs PROTO(( node* ));
staticforward int numbnodesingraph PROTO(( node* ));
staticforward int numberofwiredoutputports PROTO(( node* ));
staticforward int largestinputportnumber PROTO(( node* ));
...
staticforward node* tonextfunction PROTO(( node* ));
staticforward stentry* searchtypetable PROTO(( char,stentry*,stentry*,stryng ));
...
staticforward void smashtypes PROTO(( void ));
staticforward void adjustgraphptrs PROTO(( void ));
staticforward stentry* getbasictype PROTO(( char ));
staticforward stentry* getwildtype PROTO(( void ));
staticforward stentry* getconstructortype PROTO(( char,stentry* ));
staticforward void putintable PROTO(( stentry** ));
...
staticforward port* insertedge PROTO(( node*,int,node*,int,stentry*,stryng ));
staticforward port* insertliteral PROTO(( node*,int,stentry*,stryng,stryng ));
staticforward void renumbergraph PROTO(( node*,boolean ));
staticforward void shiftinputports PROTO(( node*,int,int ));
staticforward void shiftoutputports PROTO(( node*,int,int ));
staticforward node* copynode PROTO(( node* ));
staticforward node* copycompound PROTO(( node* ));
...
staticforward void compactports PROTO(( node* ));
staticforward void buildbasictype PROTO(( char,Char* ));
staticforward void initmodule PROTO(( void ));
...
staticforward void findnodes PROTO(( node*,boolean,struct LOC_graphwalk* ));
...
staticforward void newtornlist PROTO(( tornrec**,torntype ));
staticforward void freetornlist PROTO(( tornrec** ));
staticforward void newttptr PROTO(( stentry**,char ));
staticforward void freettptr PROTO(( stentry** ));
staticforward node* newnodeptr PROTO(( nodesort,treestackobj* ));
staticforward port* newedgeptr PROTO(( portsort ));
staticforward linkrec* newlinkageptr PROTO(( linksort ));
